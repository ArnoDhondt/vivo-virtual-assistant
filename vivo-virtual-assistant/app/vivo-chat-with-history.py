...
if __name__ == '__main__':
    ...
    st.header("VIVO Virtual Assistant")
    # ChatInput
...
""")
        ...
        context = st.selectbox("Selecteer je context", options=["VIVO-Bezoeker"], help="""VIVO-Bezoeker: website bezoeker""")
            ...
            for c in output['context']:                    
                ...
                if 'active_planned_courses' in c.metadata:
                    ...
                    if foundPlannedCourses is not None:
                        for plannedCourseId in foundPlannedCourses:
                            sources.append(f"[Klik hier voor Inschrijfbare Geplande Cursus](https://vivo.be/opleidingsaanbod/{plannedCourseId}/cursus-detail)\n")
